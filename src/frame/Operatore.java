 ...
 * @author hew15bc502nl
 */
public class Operatore extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Operatore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
