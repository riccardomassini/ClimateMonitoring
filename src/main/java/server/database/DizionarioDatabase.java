...
public class DizionarioDatabase {
    ...
    public static final String MISURAZIONI_ATTRIBUTO_VALUTAZIONE__VENTO = "Vento";
    ...
    public static final String MISURAZIONI_ATTRIBUTO_VALUTAZIONE_ALTEZZAGHIACCIAI = "AltezzaGhiacciai";
    public static final String MISURAZIONI_ATTRIBUTO_COMMENTO_ALTEZZAGHIACCIAI = "AltezzaGhiacciaiNote";
