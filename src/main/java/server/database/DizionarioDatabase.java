...
public class DizionarioDatabase {
    ...
    public static final String OPERATORI_ATTRIBUTO_IDCENTROMONITORAGGIO = "NomeCentro";
    ...
    public static final String MISURAZIONI_ATTRIBUTO_IDCENTROMONITORAGGIO = "NomeCentro";
    ...
    public static final String PUNTIINTERESSEASSOCIATI_ATTRIBUTO_IDCENTROMONITORAGGIO = "NomeCentro";
